...
ActiveRecord::Schema.define(version: 20140324210100) do
  ...
  add_index "likes", ["update_id"], name: "index_likes_on_update_id", using: :btree
  ...
  add_index "updates", ["task_id"], name: "index_updates_on_task_id", using: :btree
